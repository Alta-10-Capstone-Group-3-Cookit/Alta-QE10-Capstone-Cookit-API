Feature: Post Create Personal Label
  ...
  Scenario: Post create a new personal label with valid name in request body
    ...
    Then API response for create a new personal label should return 200 OK status code
  ...
  Scenario: Post Create a new task with empty content key
    ...
    Then API response for create a new personal label should return 400 Bad Request status code

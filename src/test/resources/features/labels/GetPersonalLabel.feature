Feature: Get a Personal Label
  ...
  Scenario: Get a personal labels with available id path
    ...
    Then API response for get a personal label should return 200 OK status code
  ...
  Scenario Outline: Get a personal labels with unavailable id path
    ...
    Then API response for get a personal label  should return 404 Not Found status code
    Examples:
      | id         |
      | 1111122222 |
